...
import { Save, Lock, User, Mail, Users, Calendar, FileText } from 'lucide-vue-next'
      ...
      <div class="card h-100">
        ...
        <div class="card-body p-4">
          <div class="row mb-4 align-items-center">
            <div class="col-auto">
              <div
                class="bg-info border border-dark d-flex align-items-center justify-content-center rounded-circle"
            ...
            <div class="col">
              ...
              <span class="badge text-black small">講師</span>
            </div>
          </div>
          ...
          <form @submit.prevent="updateUserProfile">
            ...
            <div class="mb-3">
              <label class="fw-bold mb-1"><FileText :size="14" /> 講師簡介</label>
              <textarea
                class="form-control"
                rows="3"
                v-model="form.bio"
