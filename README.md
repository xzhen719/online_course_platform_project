...
![iKnowVation_homepage](./docs/iKnowVation_homepage.png)


## 專案說明

- **前後端分離架構**：採用Spring Boot 3 + Vue 3，並整合綠界金流 (ECPay) 與 JWT 安全機制，模擬電商從產品瀏覽到支付完成的業務流程。
- **獎勵機制**：為提升學習動機，實作了「完課獎勵系統」。當學生完成某一課程的所有章節後，系統將自動觸發邏輯，隨機發放 5%~15% 的折價券，鼓勵學生繼續探索下一門課程。
- **課程描述生成**：整合 OpenRouter AI，幫助講師快速生成專業的課程簡介與大綱，減少開課前的內容準備時間。
![iKnowVation_couponDemo](./docs/iKnowVation_couponDemo.png)
